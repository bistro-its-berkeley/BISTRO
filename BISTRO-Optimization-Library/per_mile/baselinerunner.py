...
CONFIG_PATH = "/fixed-data/sioux_faux/sioux_faux-157k.conf"
...
input_dir = os.path.abspath(f"./submission-inputs/baseline")
...
output_dir = os.path.abspath(f"./output/baseline")
